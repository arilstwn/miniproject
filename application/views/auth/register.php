...
<style>
body {
  background-image: url('https://e1.pxfuel.com/desktop-wallpaper/969/587/desktop-wallpaper-warna-polos-gambar-warna-ungu.jpg');
            ...
            <div class="card-body p-5">
              ...
              <input class="input-field" type="password" placeholder="Pasuwādo o nyūryoku shite kudasai" name="password">
                ...
                <div class="form-check d-flex justify-content-center mb-5">
                  ...
                  Koko o chekkushitekudasai, kyōdai <a href="#!" class="text-body"><u>情報</u></a>
                  </label>
                </div>
