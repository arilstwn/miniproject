...
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <a href="http://localhost/codeigniter-3/admin" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                 ...
                 $no= 0;foreach ($siswa as $row  ) :$no++                          
                    ?>
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-2 text-gray-700"><?php echo $row->id_mapel ?>
                                 </td>
                                 <td class="whitespace-nowrap px-4 py-2 text-gray-700">
                                    <?php echo tampil_full_kelas_byid($row->guru_mapel); ?>
                                 </td>
                                 <td class="whitespace-nowrap px-4 py-2 text-gray-700">
                                    <a href="http://localhost/codeigniter-3/admin/ubah_siswa"<?php echo base_url('admin/ubah_siswa/').$row->nama-guru ?>>Ubah</a>
